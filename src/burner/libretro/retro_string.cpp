...
static const char* multi_language_strings_ext[MAX_LANGUAGES][NUM_STRING_EXT] = {
	{
		"Allow Ignore CRC",
		"The prerequisite is to enable 'Allow patched romsets'. No longer strictly requiring Rom to have the correct CRC and file size to run, allowing Rom with the correct file name and file size to run. Resolve the issue of ROM not running due to CRC differences between new and old versions. Without CRC check, the loaded game content may not match the expected game content",
		"PGM2 Memory Cards",
		"Select memory card before character selection. Default: auto-created default card. 'Create New (timestamped)' makes a fresh card. Memory Card files location: System/BIOS/fbneo/memcards/",
		"Default (auto-created)",
		"PGM2 slot P%c: default + %u file(s)",
		"Choice 0 auto-creates and saves the default card. Choice 'Create New (timestamped)' makes a fresh card and switches to it. Other files must start with ",
		"_pN_ and live in System/BIOS/fbneo/memcards/ with .pg2 or .bin extension"
	},
	{	// Simplified Chinese
		"\u5141\u8bb8\u5ffd\u7565CRC",
		"\u5148\u51b3\u6761\u4ef6\u662f\u542f\u7528'\u5141\u8bb8\u4fee\u8865\u96c6\u7ec4'.\u4e0d\u518d\u4e25\u683c\u8981\u6c42 ROM \u5177\u6709\u6b63\u786e\u7684 CRC \u548c\u6587\u4ef6\u5927\u5c0f\u624d\u80fd\u8fd0\u884c,\u5141\u8bb8\u5177\u6709\u6b63\u786e\u7684\u6587\u4ef6\u540d\u548c\u6587\u4ef6\u5927\u5c0f\u7684 ROM \u8fd0\u884c,\u89e3\u51b3\u7531\u4e8e\u65b0\u65e7\u7248\u672c\u4e4b\u95f4\u7684 CRC \u5dee\u5f02\u5bfc\u81f4 ROM \u65e0\u6cd5\u8fd0\u884c\u7684\u95ee\u9898.\u6ca1\u6709 CRC \u6821\u9a8c,\u52a0\u8f7d\u7684\u6e38\u620f\u5185\u5bb9\u53ef\u80fd\u4e0e\u9884\u671f\u7684\u6e38\u620f\u5185\u5bb9\u4e0d\u5339\u914d",
		"PGM2 \u5b58\u50a8\u5361",
		"\u5728\u9009\u62e9\u89d2\u8272\u524d\u9009\u62e9\u5b58\u50a8\u5361\u3002\u9ed8\u8ba4\uff1a\u81ea\u52a8\u521b\u5efa\u7684\u9ed8\u8ba4\u5361\u3002\u53ef\u4ee5\u65b0\u5efa\u65f6\u95f4\u6233\u5361\u3002\u5b58\u50a8\u5361\u6587\u4ef6\u4f4d\u7f6e\uff1aSystem/BIOS/fbneo/memcards/",
		"\u9ed8\u8ba4\u5361\uff08\u81ea\u52a8\u521b\u5efa\uff09",
		"PGM2 \u63d2\u69fd P%c: \u9ed8\u8ba4\u5361 + %u \u4e2a\u6587\u4ef6",
		"\u9009\u9879 0 \u4f1a\u81ea\u52a8\u521b\u5efa\u5e76\u4fdd\u5b58\u9ed8\u8ba4\u5361\u3002\u9009\u9879\u201c\u65b0\u5efa\uff08\u65f6\u95f4\u6233\uff09\u201d\u4f1a\u521b\u5efa\u65b0\u5361\u5e76\u5207\u6362\u5230\u5b83\u3002\u5176\u4ed6\u6587\u4ef6\u540d\u5fc5\u987b\u4ee5 '",
		"_p\u73a9\u5bb6\u7f16\u53f7_' \u5f00\u5934\uff0c\u4f4d\u4e8e System/BIOS/fbneo/memcards/\uff0c\u5e76\u4ee5 '.pg2' \u6216 '.bin' \u7ed3\u5c3e"
	},
	{	// Traditional Chinese
		"\u5141\u8a31\u5ffd\u7565CRC",
		"\u5148\u6c7a\u689d\u4ef6\u662f\u555f\u7528'\u5141\u8a31\u4fee\u88dc\u96c6\u7d44'.\u4e0d\u518d\u56b4\u683c\u8981\u6c42 ROM \u5177\u6709\u6b63\u78ba\u7684 CRC \u548c\u6587\u4ef6\u5927\u5c0f\u624d\u80fd\u904b\u884c,\u5141\u8a31\u5177\u6709\u6b63\u78ba\u7684\u6587\u4ef6\u540d\u548c\u6587\u4ef6\u5927\u5c0f\u7684 ROM \u904b\u884c,\u89e3\u6c7a\u7531\u65bc\u65b0\u820a\u7248\u672c\u4e4b\u9593\u7684 CRC \u5dee\u7570\u5c0e\u81f4 ROM \u7121\u6cd5\u904b\u884c\u7684\u554f\u984c.\u6c92\u6709 CRC \u6821\u9a57,\u52a0\u8f09\u7684\u904a\u6232\u5167\u5bb9\u53ef\u80fd\u8207\u9810\u671f\u7684\u904a\u6232\u5167\u5bb9\u4e0d\u5339\u914d",
		"PGM2 \u5b58\u5132\u5361",
		"\u5728\u9078\u64c7\u89d2\u8272\u524d\u9078\u64c7\u5b58\u5132\u5361\u3002\u9810\u8a2d\uff1a\u81ea\u52d5\u5efa\u7acb\u7684\u9810\u8a2d\u5361\u3002\u53ef\u4ee5\u65b0\u5efa\u6642\u9593\u6233\u5361\u3002\u5b58\u5132\u5361\u6a94\u6848\u4f4d\u7f6e\uff1aSystem/BIOS/fbneo/memcards/",
		"\u9810\u8a2d\u5361\uff08\u81ea\u52d5\u5efa\u7acb\uff09",
		"PGM2 \u63d2\u69fd P%c: \u9810\u8a2d\u5361 + %u \u500b\u6a94\u6848",
		"\u9078\u9805 0 \u6703\u81ea\u52d5\u5efa\u7acb\u4e26\u5132\u5b58\u9810\u8a2d\u5361\u3002\u9078\u9805\u300c\u65b0\u5efa\uff08\u6642\u9593\u6233\uff09\u300d\u6703\u5efa\u7acb\u65b0\u5361\u4e26\u5207\u63db\u5230\u5b83\u3002\u5176\u4ed6\u6a94\u6848\u540d\u7a31\u5fc5\u9808\u4ee5 '",
		"_p\u73a9\u5bb6\u7de8\u865f_' \u958b\u982d\uff0c\u4f4d\u65bc System/BIOS/fbneo/memcards/\uff0c\u4e26\u4ee5 '.pg2' \u6216 '.bin' \u7d50\u5c3e"
	}
};
